    ...
    private function loguear()
    {
        ...
        if (self::autenticar($correo, $contrasena)) {
            ...
            if ($usuarioBD != null) {
                ...
                return ["estado" => true, "mensaje" => "Correcto", "usuario" => $respuesta];
            } else {
                return ["estado" => false, "mensaje" => "Ha ocurrido un error"];
            }
        } else {
            return ["estado" => false, "mensaje" => "Correo o contraseña inválidos"];
        }
    }
